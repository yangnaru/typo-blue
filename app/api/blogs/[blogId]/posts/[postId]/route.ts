...
export async function GET(request: NextRequest, { params }: { params: { blogId: string, postId: string } }) {
...
export async function POST(request: NextRequest, { params }: { params: { blogId: string, postId: string } }) {
...
export async function DELETE(request: NextRequest, { params }: { params: { blogId: string, postId: string } }) {
    const post = await prisma.post.findUnique({
        where: {
            uuid: decodePostId(params.postId),
        },
