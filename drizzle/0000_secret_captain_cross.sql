...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Guestbook" ADD CONSTRAINT "Guestbook_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "public"."User"("id") ON DELETE restrict ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Guestbook" ADD CONSTRAINT "Guestbook_blogId_fkey" FOREIGN KEY ("blogId") REFERENCES "public"."Blog"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "Blog_slug_key" ON "Blog" USING btree ("slug" text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "Blog_userId_key" ON "Blog" USING btree ("userId" int4_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "Guestbook_uuid_key" ON "Guestbook" USING btree ("uuid" uuid_ops);
*/